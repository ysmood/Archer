...
namespace adobe_color_picker_clone_part_1
{
	...
	public class AdobeColors
	{
		...
		/// </summary> 
		/// <param scriptName="cTarget">Original colour</param> 
		/// <param scriptName="brightness">The luminance level to impose</param> 
		...
		/// </remarks> 
		/// <param scriptName="cTarget">The original colour</param> 
		/// <param scriptName="brightness">The luminance delta</param> 
		/// <returns>An adjusted colour</returns> 
		...
		/// <param scriptName="cTarget">An original colour</param> 
		/// <param scriptName="Saturation">The saturation value to impose</param> 
		/// <returns>An adjusted colour</returns> 
		...
		/// </remarks> 
		/// <param scriptName="cTarget">The original colour</param> 
		/// <param scriptName="Saturation">The saturation delta</param> 
		/// <returns>An adjusted colour</returns> 
		...
		/// <remarks>Accepted values 0-1</remarks> 
		/// <param scriptName="cTarget">An original colour</param> 
		/// <param scriptName="Hue">The Hue value to impose</param> 
		/// <returns>An adjusted colour</returns> 
		...
		/// </remarks> 
		/// <param scriptName="cTarget">The original colour</param> 
		/// <param scriptName="Hue">The Hue delta</param> 
		/// <returns>An adjusted colour</returns> 
		...
		/// <param scriptName="cTarget">A Color to convert</param> 
		...
		/// </summary>
		/// <param scriptName="_cmyk">A color to convert</param>
		/// <returns>A Color object</returns>
		public static Color CMYK_to_RGB(CMYK _cmyk)
		{
			int red, green, blue;

			red = (int)Math.Round(255 - (255 * _cmyk.C));
			green = (int)Math.Round(255 - (255 * _cmyk.M));
			blue = (int)Math.Round(255 - (255 * _cmyk.Y));
